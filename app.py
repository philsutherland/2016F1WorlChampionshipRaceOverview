...
print("--------------------------------------------------------")
print("───────────────────────────────────────────────────────────────────────────")
print("| Grand Prix Location | Nico Rosberg | Lewis Hamilton | Point Difference  |")
print("───────────────────────────────────────────────────────────────────────────")
...
for score in Rosberg_Hamilton_score:
    ...
    print(
        "| {:^19} | ({}) {:^8} | ({}) {:^11} | {:^+16} |".format(score[0], score[1], Rosberg_points, score[2], Hamilton_points, Rosberg_points - Hamilton_points))
    # print
    #  f"          {score[0]}               ({score[1]}) {Rosberg_points}               ({score[2]}) {Hamilton_points}        {Rosberg_points - Hamilton_points}")
